...
namespace Micologia
{
    public partial class ExameConsulta : Form
    {
            ...
            if (lista.Count > 0)
            {
                ...
                for (int i = 0; i < listaExame.Count; i++)
                {
                    dgvConsulta.Rows.Add("Excluir", "Alterar", "Relatório", listaExame[i].nNumero.ToString(), listaExame[i].Paciente.sNome, listaExame[i].dDataExame.ToString("dd/MM/yyyy"),
                                         listaExame[i].nProntuario, listaExame[i].sMedicoSolicitante, listaExame[i].nIDExame.ToString());
                }
        ...
        private void gerarColunaDataGridView()
        {
            ...
            dgvConsulta.Columns.Add("numero", "No Exame");
        ...
        private void Excluir(int id)
        {
            ...
            {
                util.ExecutarSqlCrud("DELETE FROM MICOLOGIA_ExameResultado WHERE nIDExame = " + id.ToString());
        ...
        private void popularAno()
        {
            ...
            if (DateTime.Now.Year >= 2015) this.cmbAno.Items.Insert(4, "2015");
            if (DateTime.Now.Year >= 2016) this.cmbAno.Items.Insert(5, "2016");
            if (DateTime.Now.Year >= 2017) this.cmbAno.Items.Insert(6, "2017");
            if (DateTime.Now.Year >= 2018) this.cmbAno.Items.Insert(7, "2018");
            if (DateTime.Now.Year >= 2019) this.cmbAno.Items.Insert(8, "2019");
            if (DateTime.Now.Year >= 2020) this.cmbAno.Items.Insert(9, "2020");
