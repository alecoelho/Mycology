...
namespace Micologia
{
    public partial class Resultado : Form
    {
        ...
        Modelo.MICOLOGIA_Resultado entity;

        public Resultado(int pCodigo)
        {
            InitializeComponent();
        ...
        private void Salvar()
        {
            ...
            if (entity == null)
                entity = new Modelo.MICOLOGIA_Resultado();
        ...
        private bool Criticar()
        {
            ...
            {
                MessageBox.Show("Exame Obrigatório", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
            return true;
        }
