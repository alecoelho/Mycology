    ...
    public partial class ExameConsulta : Form
    {
        ...
        private void CarregarGrid()
        {
            ...
            if (lista.Count > 0)
            {
                ...
                {
                    dgvConsulta.Rows.Add("Excluir", "Alterar", "Relatório", listaExame[i].nNumeroExame.ToString(), listaExame[i].Paciente.sNome, listaExame[i].dDataExame.ToString("dd/MM/yyyy"),
        ...
        private void popularAno()
        {
            ...
            this.cmbAno.Items.Insert(2012, "2012");
            this.cmbAno.Items.Insert(2013, "2013");
            this.cmbAno.Items.Insert(2014, "2014");

            if (DateTime.Now.Year >= 2015) this.cmbAno.Items.Insert(2015, "2015");
            if (DateTime.Now.Year >= 2016) this.cmbAno.Items.Insert(2016, "2016");
            if (DateTime.Now.Year >= 2017) this.cmbAno.Items.Insert(2017, "2017");
            if (DateTime.Now.Year >= 2018) this.cmbAno.Items.Insert(2018, "2018");
            if (DateTime.Now.Year >= 2019) this.cmbAno.Items.Insert(2019, "2019");
            if (DateTime.Now.Year >= 2020) this.cmbAno.Items.Insert(2020, "2020");
