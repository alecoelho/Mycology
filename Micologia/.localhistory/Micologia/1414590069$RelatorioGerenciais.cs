    ...
    public partial class RelatorioGerenciais : Form
    {
        ...
        private void gerarPlanilha()
        {
            ...
            if (listaResultados.Count > 0)
            {
                ...
                var resultado = from linha in listaResultados
                                group linha by linha.nNumeroExame into grupo
        ...
        private void criarPlanilha(int colMax)
        {
            ...
            try
            {
                ...
                {
                    dt.Rows.Add(new string[] { listaExames[kIndex].nNumeroExame.ToString(), "'" + listaExames[kIndex].dDataExame.ToString("dd/MM/yyyy"), listaExames[kIndex].nProntuario.ToString(),
                    ...
                    var lista = from row in listaResultados
                                where row.nNumeroExame == listaExames[kIndex].nNumeroExame
                                select row;
